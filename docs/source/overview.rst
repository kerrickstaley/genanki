...
You *cannot* put ``<img src="{MyMedia}">`` in the template and ``image.jpg`` in the field. See these sections in the Anki manual for more information: `Importing Media <https://docs.ankiweb.net/#/importing?id=importing-media>`_ and `Media & LaTeX <https://docs.ankiweb.net/#/templates/fields?id=media-amp-latex>`_.
